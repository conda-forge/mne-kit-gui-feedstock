...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mne-kit-gui-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14317&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mne-kit-gui-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mne-kit-gui` can be installed with:

```
conda install mne-kit-gui
```

It is possible to list all of the versions of `mne-kit-gui` available on your platform with:
